...
__decorate([
    ...
    __param(0, (0, common_1.Body)(new yup_pipe_1.YupValidationPipe(auth_schema_1.signInSchema))),
...
__decorate([
    ...
    openapi.ApiResponse({ status: 201 }),
    __param(0, (0, common_1.Body)(new yup_pipe_1.YupValidationPipe(auth_schema_1.signUpSchema))),
    __param(1, (0, common_1.Res)()),
    __metadata("design:type", Function),
